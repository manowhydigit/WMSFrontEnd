...
const Customer = () => {
  ...
  const getAllBranches = async () => {
    try {
      ...
      if (response.data?.paramObjectsMap?.branchVO) {
        ...
        setBranchList([]); // Set empty array if structure doesn't match
      }
    } catch (error) {
      console.error("Error fetching branches:", error);
      setBranchList([]); // Set empty array on error
    }
  };
  // Fetch all countries
  const getAllCountries = async () => {
    try {
      ...
      if (response.data?.paramObjectsMap?.countryVO) {
        ...
        console.warn("Unexpected countries response structure:", response.data);
        setCountryList([]);
      }
    } catch (error) {
  ...
  const getAllStates = async (country) => {
    try {
      ...
      if (response.data?.paramObjectsMap?.stateVO) {
        ...
        console.warn("Unexpected states response structure:", response.data);
        setStateList([]);
      }
    } catch (error) {
  ...
  const getAllCities = async (state) => {
    try {
      ...
      if (response.data?.paramObjectsMap?.cityVO) {
        ...
        console.warn("Unexpected cities response structure:", response.data);
        setCityList([]);
      }
    } catch (error) {
  ...
  // Handle add row to client table
  ...
  // Handle add row to branch table
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <TabPane tab="Client & Branch" key="2">
                      <div
                        style={{
                          backdropFilter: "blur(10px)",
                          background: "rgba(255, 255, 255, 0.1)",
                                    ...
                                    >
                                      ...
                                      >
                                        <Button
                                          icon={<DeleteOutlined />}
                                          onClick={() =>
                                            handleDeleteRow(item.id, "client")
                                          }
                                          danger
                                          type="text"
                                          style={{ color: "#ff4d4f" }}
                                    ...
                                    >
                                      ...
                                      >
                                        <Button
                                          icon={<DeleteOutlined />}
                                          onClick={() =>
                                            handleDeleteRow(item.id, "branch")
                                          }
                                          danger
                                          type="text"
                                          style={{ color: "#ff4d4f" }}
