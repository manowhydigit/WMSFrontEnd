...
const menuCategories = [
  {
    ...
    items: [
      { name: "BUYER ORDER", backendName: "BUYERORDER" },
      { name: "PICK REQUEST", backendName: "PICKREQUEST" },
      { name: "REVERSE PICK", backendName: "REVERSEPICK" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { name: "MULTIPLE BUYER ORDER", backendName: "PENDINGBUYERORDER" },
      { name: "MULTIPLE PICK REQUEST", backendName: "PENDINGPICKREQUEST" },
    ],
  },
  {
    category: "TT Management",
    items: [
      { name: "TT Listing", backendName: "TTLISTING" },
      { name: "TT Approved List", backendName: "TTAPPROVEDLIST" },
    ],
  },
  {
    category: "WH Management",
    items: [
      { name: "WH Listing", backendName: "WHLISTING" },
...
const routes = {
  ...
  "MULTIPLE BUYER ORDER": "/PendingBuyerOrder",
  "MULTIPLE PICK REQUEST": "/PendingPickRequest",
